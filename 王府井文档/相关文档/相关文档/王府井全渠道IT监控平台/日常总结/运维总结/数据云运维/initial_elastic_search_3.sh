...
echo "cluster.name: wfj-es" > elasticsearch.yml;
echo "node.name: node-29" >> elasticsearch.yml;
echo "network.host: "10.6.100.29"" >> elasticsearch.yml;
...
echo "discovery.zen.ping.unicast.hosts: ["10.6.100.29", "10.6.100.30", "10.6.100.31", "10.6.100.32", "10.6.100.33"]" >> elasticsearch.yml;
echo "discovery.zen.minimum_master_nodes: 3" >> elasticsearch.yml;
echo "gateway.recover_after_nodes: 3" >> elasticsearch.yml;
